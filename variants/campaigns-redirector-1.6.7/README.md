...
- Blocage des User-Agents automatisés/bizarres (`curl`, `wget`, `python-requests`, etc.) sans considérer un UA vide comme suspect
...
- Scanner detection (HEAD, UA patterns, prefetch)
